...
namespace CapaPresentacionWF
{
    public partial class MDIRecursos : Form
    {
        ...
        {
            DialogResult res = System.Windows.Forms.MessageBox.Show("Esta seguro que quiere cerrar la aplicacion",
        ...
        private void solicitudMenu_Click(object sender, EventArgs e)
        {
            if (Application.OpenForms["Solicitud"] != null)
            {
                Application.OpenForms["Solicitud"].Activate();
            }
            else
            {
                Solicitud fr = new Solicitud();
                fr.MdiParent = this;
                fr.Show();
            }
        }
