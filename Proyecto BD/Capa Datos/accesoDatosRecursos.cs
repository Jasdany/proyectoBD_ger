   ...
   public class accesoDatosRecursos
    {
        ...
        public int insertarRecursos(Recursos r)
        {
            ...
            try
            {
                ...
                cm = new SqlCommand("recurso", cnx); //Nombre del procedimiento 
                cm.Parameters.AddWithValue("@b", 1); //Valores que toman los parametros
                cm.Parameters.AddWithValue("@idrecurso",""); //del procedimiento
                cm.Parameters.AddWithValue("@nombre", r.nombrer);
        ...
        public int EliminarRecursos(int idrec)
        {
            ...
            try
            {
                ...
                cm.Parameters.AddWithValue("idrecurso", idrec); //parametro del procedimiento almacenado
                cm.Parameters.AddWithValue("@nombre", "");
                cm.Parameters.AddWithValue("@codigo", "");
                cm.Parameters.AddWithValue("@descripcion", "");
